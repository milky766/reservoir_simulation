...
from model_new import ESN, Tikhonov, pd_control, dynamics, generate_teaching_trajectories   # model.pyのESNとTikhonovクラスをインポート
...
for pos in test_initial_positions_angles:
    esn_predicted_angle_seq , esn_torque_seq, esn_real_angle_seq, esn_error_seq = esn.trajectory2(pos, steps, KP, KD, dt, target_angles)
